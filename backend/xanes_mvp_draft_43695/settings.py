"""
Django settings for xanes_mvp_draft_43695 project.
...
ROOT_URLCONF = 'xanes_mvp_draft_43695.urls'
...
WSGI_APPLICATION = 'xanes_mvp_draft_43695.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "xanes_mvp_draft_43695 API",
    "DESCRIPTION": "API documentation for xanes_mvp_draft_43695 App",
    "VERSION": "v1",
}
